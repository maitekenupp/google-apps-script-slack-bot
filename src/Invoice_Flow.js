 ...
 *
 * Purpose:
 * Contractor-facing monthly invoice submission flow.
 *
 * Menu:
  ...
  return [
    ...
    },
    {
      ...
      elements: [
        ...
        primaryButton_("✅ Finish", "invoice_finish_review")
      ]
    },
    {
      type: "actions",
...
function handleInvoiceCreateConfirm_(channelId, messageTs, userId, wantsFileUpload) {
  ...
  updateIzaMenu(
    channelId,
    messageTs,
    buildInvoiceSubmittedBlocks_(contractor.email),
    "Invoice Submitted"
  );
}
...
function buildInvoiceSubmittedBlocks_(contractorEmail) {
  return [
    {
      type: "section",
      text: {
        ...
        text:
          "✅ *Invoice Submitted*\n\n" +
          "Your invoice PDF is ready and was shared with:\n" +
